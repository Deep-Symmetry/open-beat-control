...
:includeArgumentDescriptions: false
...
:includeArgumentDescriptions: true
include::partial$stream_arguments.adoc[]

:streamType: device
:streamCommand: /devices
:streamPort: 4000
...
Find out the playing states of Pro DJ Link players on the network,
either now or (by setting up a stream) as they change.

:includeArgumentDescriptions: true
include::partial$stream_arguments.adoc[]

:streamType: playing state
:streamCommand: /playing
:streamPort: 4001
include::partial$stream_commands.adoc[]
