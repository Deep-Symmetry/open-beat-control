...
* `/logging stream` (future log messages will be sent to the default
  response port)
* `/logging stream 1492` (future log messages will be sent port 1492)
...
* `received: /log 2019-Oct-31 23:50:42 INFO [open-beat-control.core:222] - Virtual CDJ running as Player 5`
